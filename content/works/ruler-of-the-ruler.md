...
medium: 중철 제본, Saddle Stitch Binding
dimensions: 210× 297
pages: 40
description_kr: |-
  《Ruler of the Ruler》는 수집된 26개의 자(Ruler)를 실험 대상으로 삼아, 측정 도구였던 자를 조형 재료로 다룬다. 자의 물리적 구조를 따라 조합하고 배치하는 일련의 과정을 통해, ‘기준’이라는 개념의 재해석을 시도한다. 책은 총 34개의 연작을 엮은 구성이다. 각 연작은 자의 형태나 쓰임에서 출발해 개별적으로 작업되었지만, 자들은 서로 다른 장면에 반복되거나 변형된 형태로 재등장한다. 그로 인해 작업들 사이에는 느슨하지만 유기적인 연결이 형성된다.
  지면은 ISO 216 규격의 A4 판형을 따른다. 자가 사용되는 문서 환경을 실험의 기반으로 삼고, 그 안에서 겹침, 어긋남, 비틀림 같은 조형적 개입이 이루어진다. 작업자는 기준을 설정하고 따르되, 그것을 흔들고 다시 구성하는 과정을 반복한다. 각 장면의 자들은 실제 크기(1:1)로 인쇄되어, 독자는 책 위에 물건을 올려두고 직접 재볼 수 있다.
